...
public class SearchActivity extends AppCompatActivity {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.nav_information:
                                startActivity(new Intent(SearchActivity.this, ImformationActivity.class));
                            ...
                            case R.id.nav_search2:
                                startActivity(new Intent(SearchActivity.this, MountainSearchActivity.class));
                                finish();
                                break;
                        }
                        return false;
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new SForestListFragment(),"");
